...
if __name__ == "__main__":
    ...
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend2")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend3")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend4")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend5")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend6")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend7")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend8")
    bot = SelfImprovingBot(max_context_length=5000, dynamic_context_window=550, name="hellofriend9")
    print("just finished")
